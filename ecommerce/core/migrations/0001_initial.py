# Generated by Django 5.1 on 2024-08-19 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='No City Provided', max_length=100)),
                ('state', models.CharField(default='No State Provided', max_length=100)),
                ('zipcode', models.CharField(default='00000', max_length=20)),
                ('country', models.CharField(default='No Country Provided', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shipping', to='core.order')),
            ],
        ),
        migrations.CreateModel(
            name='Wishlist',
